...
function OrgProfile() {
    ...
    const handleImageUpload = async (e) => {
        ...
        try {
            ...
            setProfile({ ...profile, profile_pic_url: response.data.profile_pic_url });
            setStatusMessage({ type: "success", text: "Profile picture updated!" });
            setTimeout(() => setStatusMessage({ type: "", text: "" }), 3000);
        } catch (error) {
            console.error("🚨 Failed to upload image:", error);
            setErrors({ general: "Failed to upload profile picture. Try again." });
            ...
            <div className="w-full flex-1 p-4 pt-24 md:p-10 lg:p-16 overflow-y-auto">
                ...
                {loading ? (
                    ...
                    <div className="max-w-3xl bg-white rounded-3xl shadow-sm border border-gray-200 p-5 md:p-8 flex flex-col gap-8 relative">
                        ...
                        {/* --- AVATAR HEADER WITH CAMERA ICON --- */}
                        <div className="flex items-center gap-6 pb-6 border-b border-gray-100">
                            
                            {/* Relative container around the avatar logic */}
                            <div className="relative shrink-0 group">
                                {profile.profile_pic_url ? (
                                    ...
                                    <div className="w-24 h-24 rounded-full bg-purple-50 flex items-center justify-center border-4 border-purple-100 shadow-sm">
                                ...
                                <button
                                    ...
                                    className="absolute bottom-0 right-0 p-2 bg-[#6E39CB] text-white rounded-full border-2 border-white hover:bg-[#5a2ca0] shadow-md transition-all cursor-pointer group-hover:scale-105"
                                >
